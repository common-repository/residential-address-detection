...
if (!class_exists("EnWooAddonPluginDetail")) {
    ...
    class EnWooAddonPluginDetail
    {
        ...
        /**
         * priority_one_dependencies for eniture woo addons
         * @return array
        */
        public function priority_one_dependencies()
        {
                ...
                "priority_one" => array(
                    'addons' => array(
                        'auto_residential_detection_addon' => array(
                            ...
                            'section' => 'section-2',
                            'after_index_fields' => array(
                                'show_delivery_estimate_priority_one'
                            ),
                            'unset_fields' => array(),
                            'reset_always_auto_residential' => array(
                                'en_quote_settings_residential_delivery_priority_one',
                            ),
                        ),
                        'lift_gate_delivery_addon' => array(
                            'active' => true,
                            ...
                            'unset_fields' => array(),
                            'reset_always_lift_gate' => array(
                                'en_quote_settings_liftgate_delivery_priority_one'
                            )
                        ),
                        'box_sizing_addon' => array(
                            'active' => false,
